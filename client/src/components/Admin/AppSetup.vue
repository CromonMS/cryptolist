<template>
  <div class="container is-fluid">
    <div class="container">
      ...
      <div class="field">
        <label class="checkbox" for="admin">
          <input type="checkbox" name="admin" v-model="user.admin" checked>
          Admin?
        </label>
      </div>
      <div class="field is-grouped">
        <div class="control">
          <button class="button is-link" @click.prevent="addUser">SUBMIT</button>
        </div>
        <div class="control">
    ...
    <div class="container">
      ...
      <button class="button is-link" type="submit" @click.prevent="populateCoins">POPULATE COINS</button>
    </div>
  </div>
</template>
  ...
  methods: {
    addUser () {
      if ((this.user.email === '' || undefined) && (this.user.password === '' || undefined)) {
        console.log('Must have email and password')
        return
      }
    ...
    populateCoins () {
      this.$store.dispatch('coins/populateCoins')
    }
  }
}
</script>
